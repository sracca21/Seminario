-- Tabla Persona
INSERT INTO Persona (nombre, apellido, direccion, dni, telefono, correo)
VALUES ('Roberto', 'Sanchez', 'Cordoba 5492 - Rosario', 35654789, 3415789456, 'robertosanchez@icloud.com');

INSERT INTO Persona (nombre, apellido, direccion, dni, telefono, correo)
VALUES ('Juan', 'Perez', 'San Martin 355 - Rosario', 29486257, 3415486285, 'juanperez@icloud.com');
SELECT * FROM Persona;
...
-- Tabla Cobro
INSERT INTO Cobro (fecha, hora, monto, moneda, Venta_idVenta, Venta_tCliente_idCliente, Venta_Producto_idProducto, CuentaCorriente_idCuentaCorriente)
